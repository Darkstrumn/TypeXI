...
-- Name=Boot Sequencer
-- Author=Darkstrumn
-- Description= provides animation sequencing for "rezz-ups" of meters
-- Version=0.0.2 - 140830.14:: added more aliases
-- License=Creative Commons Attribution-Non-Commercial-Share Alike 3.0
-- Details=timeline actions\\frames are executed and at end, the meter is to be in the booted state.
-- ============================================================================
